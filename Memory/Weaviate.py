...
class Weaviate:
    ...
    def __init__(self):        
        ...
        self.class_obj = {
            "class": "Action",
            "description": "Action that can be used in a voice assistant",  # description of the class
            "properties": [
                {
                    "dataType": ["text"],
    ...
    def add_list(self, datas: list):
        ...
        with self.client.batch as batch:
            ...
            for skill_id, data in datas.items():
                ...
                results[data["id"]]["uuid"] = self.client.batch.add_data_object(properties, "Action")
        return results
    def get(self, data):
